namespace Sabotris.Translations.Locales
{
    public class LocaleEnglish : Locale
    {
        public LocaleEnglish()
        {
            ...
            _translations.Add(TranslationKey.UiMenuInputPowerUpAutoPickDelay, "Power Up Auto Pick Delay");
            _translations.Add(TranslationKey.UiMenuInputPowerUps, "Power Ups");
            ...
            _translations.Add(TranslationKey.UiMenuDisplayPowerUpAutoPickDelay, "Power Up Auto Pick Delay: {0}");
            ...
            _translations.Add(TranslationKey.UiHudPowerUpLabel, "Powers");
            _translations.Add(TranslationKey.UiHudSelectContainerLabel, "Select A Player");
            _translations.Add(TranslationKey.UiHudSelectContainerSubLabel, "To sabotage, power: {0}");
            _translations.Add(TranslationKey.UiHudSelectContainerTimerLabel, "Time remaining: {0}s");
